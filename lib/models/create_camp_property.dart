...
part '../parts/create_camp_property.dart';

class CreateCampProperty {
  String? id;
  // Merchant? merchant;
  bool? isGerBook;
  bool? isKhonog;
  ...
  num? quantity;
  String? link;
  // List<MapProperty>? similiarCreateCampProperty;
  bool? isSponsored;
  // List<Tags>? tags;
  ...
  CreateCampProperty({
    ...
    this.quantity,
    this.link,
    // this.similiarCreateCampProperty,
    this.isSponsored,
    // this.tags,
    // this.showPlaces,
    this.collateral,
  ...
  static $fromJson(Map<String, dynamic> json) =>
      _$CreateCampPropertyFromJson(json);

  factory CreateCampProperty.fromJson(Map<String, dynamic> json) =>
      _$CreateCampPropertyFromJson(json);
  Map<String, dynamic> toJson() => _$CreateCampPropertyToJson(this);
}
