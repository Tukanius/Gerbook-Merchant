...
class CreateCampData extends StatefulWidget {
  static const routeName = 'CreateCampData';
  const CreateCampData({super.key});

  @override
  State<CreateCampData> createState() => _CreateCampDataState();
}

class _CreateCampDataState extends State<CreateCampData> {
  List<File>? images = [];
