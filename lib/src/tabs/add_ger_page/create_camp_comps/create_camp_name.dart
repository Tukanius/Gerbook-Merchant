...
class CreateCampName extends StatefulWidget {
  final PageController pageController;

  const CreateCampName({super.key, required this.pageController});

  @override
  State<CreateCampName> createState() => _CreateCampNameState();
}

class _CreateCampNameState extends State<CreateCampName> {
